...
--
Значение C присвоено не будет, так как Python выдаст ошибку о несовместимости операции сложения двух разных типов переменных.
--
    >>>c = a + b
...
--
Необходимо выполнить преобразование переменной "b" в тип "int"
--
    >>> c = a + int(b) 
	  >>> c
	    3
