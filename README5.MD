...
Unseal Key 1: trPAUklnAXiOD9Xubs0a/C74bhzy3o8ZHurgxXuBFga0  
Unseal Key 2: KtbMz71gv/qLmwQU64oxZ9GGguFNJg+purzm5uj+ZO8d  
Unseal Key 3: I3r14LDFa9Jq/jrw1g9SkFb1ao6wtIFA7izgMgtXoloJ  
Unseal Key 4: RD5UYkIDhpVDx5LiHnzeWyImrAFaT3UIYSVQR8/iPN23  
Unseal Key 5: vERcHOjl3oihHJbNpPuGi4aJ/FFwTNHEqu2+2d2FJ7m4  

Initial Root Token: s.dHBe9VztkHJIBgCUYjsjDlvY  
...
vagrant@node1:~$ sudo nano /etc/nginx/ssl/pki.sh  

#!/usr/bin/bash  
PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin  
sleep 3  
vault operator unseal KtbMz71gv/qLmwQU64oxZ9GGguFNJg+purzm5uj+ZO8d  
sleep 2  
vault operator unseal I3r14LDFa9Jq/jrw1g9SkFb1ao6wtIFA7izgMgtXoloJ  
sleep 2  
vault operator unseal vERcHOjl3oihHJbNpPuGi4aJ/FFwTNHEqu2+2d2FJ7m4  
sleep 5  
vault login s.dHBe9VztkHJIBgCUYjsjDlvY  
sleep 2  
SN=$(cat /etc/nginx/ssl/nginx.vagrant.local.crt | jq -r .data.serial_number)  
sleep 2  
vault write pki_int_ca/revoke serial_number=$SN  0
sleep 2  
...
vagrant@node1:~$ chmod +x /etc/nginx/ssl/pki.sh  
